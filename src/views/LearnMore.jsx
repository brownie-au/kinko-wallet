          ...
          <MainCard className="learn-more-card" content={false}>
            <div className="learn-more-card__body">
              <section>
                ...
                <p>
                  Kinko Wallet is built with one simple rule: we will never ask for your private keys or seed phrases. Kinko Wallet
                  is a watch-only, web-based portfolio viewer and launcher. You stay in control at all times — your funds and keys
              ...
              <section>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a href="https://ethereum.org/en/developers/docs/accounts/" {...externalLinkProps}>
                      EVM public address
                    </a>{' '}
                    and give it a friendly name.
                  </li>
                  <li>
                    Create a Portfolio ID (optional): once you’ve added at least one wallet, create your unique key (for example,
                    “A1B2C3D”) to sync your wallet list across devices.
                  </li>
              ...
              <section>
                ...
                <ul>
                  <li>
                    <strong>Dashboard</strong> – view your Total Portfolio Value, Top Tokens, Transaction History, and market indicators
                    like the global market cap and the Fear &amp; Greed Index.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Staking Panels</strong> – dedicated pages for <Link to="/staking/hex">HEX</Link> and{' '}
                    <Link to="/staking/ehex">eHEX</Link> staking data.
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul>
                  <li>
                    <strong>Staking Panels</strong> – dedicated pages for <Link to="/staking/eth">ETH</Link> and{' '}
                    <Link to="/staking/pls">PLS</Link> staking data, allowing users to track their staked assets and rewards in one place.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <a href="https://app.piteas.org/" {...externalLinkProps}>Piteas</a>), mark favourites, and add new ones.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    No. Kinko is a watch-only viewer and launcher. It never holds your funds or private keys. For transaction signing,
                    use a wallet such as <a href="https://internetmoney.io/" {...externalLinkProps}>Internet Money</a> or your preferred
                    hardware wallet.
                  </p>
                </div>
                <div className="faq-item">
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Ethereum (<a href="https://ethereum.org/" {...externalLinkProps}>ethereum.org</a>), PulseChain (
                    <a href="https://pulsechain.com/" {...externalLinkProps}>pulsechain.com</a>), BSC (
                    <a href="https://www.bnbchain.org/en" {...externalLinkProps}>BNB Smart Chain</a>), Polygon (
                    <a href="https://polygon.technology/" {...externalLinkProps}>polygon.technology</a>), and Base (
                    <a href="https://base.org/" {...externalLinkProps}>base.org</a>).
                  </p>
                </div>
                <div className="faq-item">
