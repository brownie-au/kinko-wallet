...
export default function DisclaimerModal({ show, onHide }) {
  ...
  return (
    <>
      {/* Scoped styles: force dark content + light text */}
      <style>{`
        #${modalId} .kw-disclaimer-content {
          background: #1e2530; /* deep slate */
          color: #e9edf2;      /* light text */
        }
        ...
        #${modalId} .modal-title { color: #ffffff; }
        #${modalId} h6 { color: #2AC2B0; font-weight: 600; } /* Kinko green headings */
        #${modalId} p, 
        #${modalId} li, 
        #${modalId} strong { color: #e9edf2; }
        #${modalId} hr { border-color: rgba(255,255,255,0.14); }
        #${modalId} .btn-close {
          filter: invert(1) grayscale(100%);
          opacity: 0.9;
        }
        #${modalId} .btn-close:hover { opacity: 1; }
      `}</style>
      ...
      <Modal
        ...
        id={modalId}
        dialogClassName="kw-disclaimer-dialog"
        contentClassName="kw-disclaimer-content"
      >
        <Modal.Header closeButton>
          <Modal.Title id={titleId}>Kinko Wallet Disclaimer</Modal.Title>
        </Modal.Header>
        ...
        <Modal.Body>
          ...
          <h6 className="mb-1">Not Financial Advice</h6>
          <p className="mb-3">
          ...
          <h6 className="mb-1">No Custody</h6>
          <p className="mb-3">
          ...
          <h6 className="mb-1">Third-Party Integrations</h6>
          <p className="mb-3">
          ...
          <h6 className="mb-1">Risk of Loss</h6>
          <p className="mb-3">
          ...
          <h6 className="mb-1">No Guarantees</h6>
          <p className="mb-0">
